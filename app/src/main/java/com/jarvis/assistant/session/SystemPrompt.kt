...
internal object PromptSections {
    ...
    val POLICIES = """
        ...
        — На общие вопросы (знания, объяснения, советы) отвечай сам, из своих знаний; поддерживай разговор на любую тему, не отказывайся и не отделывайся отговорками.
        — Для свежих или меняющихся фактов (новости, курсы, цены, «что сейчас», «сегодня») используй встроенный поиск в интернете, а не догадки.
